...
## Example URLs
![Widget - Primary](/images/widget-chains-hamburger.png)

### Embed with primary color, theme backgrounds hidden AI input, and destination wallet
```
https://dev.mach.exchange/embed?themePrimary=%23AB0044&themeBackground=%23222222&A&hideAIInput=true&destinationWallet=0x7c5D073567f51a42B10a5B99519a51cea1959b79
```

![Widget with Intuitive Colors](/images/widget-intuit.png)
### Embed with backgrounds, destination wallet, and using intuitive color defaults
```
https://dev.mach.exchange/embed?themeBackground=%23222222&themeModalBackground=%23001A1A&useIntuitiveColorDefaults=true&destinationWallet=0x7c5D073567f51a42B10a5B99519a51cea1959b79
```

![Widget with Hamburger](/images/widget-chains-hamburger.png)
### Embed with hidden AI input, visible hamburger/slide out menu, chains set to ETH/OP, and pending transaction indicator
https://dev.mach.exchange/embed?themeBackground=%23FF1A1A&A&hideAIInput=true&chains=1,10&showHamburgerMenu=true&showPendingTX=true
